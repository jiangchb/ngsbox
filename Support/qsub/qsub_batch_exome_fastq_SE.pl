...
GATK=/users/GD/tools/GATK_src/Sting/dist/GenomeAnalysisTK.jar
...
\$BWA aln -k 2 -i 5 -q -1 -t 10 -R 0 -n 3 -o 1 -e 10 -l 28 -f \$OUTF/\$NAME.sai \$REF \$FASTQ
...
\$SHORE qVar -n \$NAME -f /users/GD/projects/genome_indices/human/hg19/shore/hg19.fasta.shore -o \$OUTF/shore/Variants -i \$OUTF/shore/map.list.gz -s /users/GD/tools/shore/Analysis/scoring_matrices/scoring_matrix_het.txt -E \$OUTF/shore/Count_SureSelect_plus150/meancov.txt -K /users/GD/projects/genome_indices/human/hg19/hg19_kmerfreq_3_11.txt -e -c 4 -d 4 -C $max_cov -r 3 -q 10 -Q 15 -a 0.25 -b 3 -y -v
...
# Annotate Enrichment
perl \$PGSP/Support/VCF/vcf_filter/vcf_filter_enriched.pl \$EXOME/Exome_Array_plus150.bed \$OUTF/SNP_Intersection/merged.vcf > \$OUTF/SNP_Intersection/merged.all.vcf
...
# Annotate Enrichment
perl \$PGSP/Support/VCF/vcf_filter/vcf_filter_enriched.pl \$EXOME/Exome_Array_plus150.bed \$OUTF/Indel_Intersection/merged.vcf > \$OUTF/Indel_Intersection/merged.all.vcf
